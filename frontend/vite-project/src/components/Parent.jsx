...
function Parent() {
  ...
  <p className='mt-10 text-center text-2xl'> <KeyboardArrowLeftIcon className='bg-gray-200 rounded-xl' onClick={ handlePreWeek}/> &nbsp; &nbsp; week {weekValue} - jan 2024 &nbsp; &nbsp; <KeyboardArrowRightIcon className='bg-gray-200 rounded-xl' onClick={handleNextWeek}/> </p>
    ...
    <Button variant="contained" style={{marginTop:"70px",marginLeft:"450px"}}>Save and Continue</Button>
